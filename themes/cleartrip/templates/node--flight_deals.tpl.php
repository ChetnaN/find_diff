...
hide($content['field_flights_to_avail']);
hide($content['field_flights_coupon_code']);
hide($content['field_flights_expiry_date']);
?>
...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <?php if(!empty($node->field_flights_expiry_date) || !empty($node->field_flights_coupon_code) || !empty($node->field_flights_to_avail)): ?>
      <div class = "bind-flights-desc">
          <?php
            print render($content['field_flights_to_avail']);
            print render($content['field_flights_coupon_code']);
            print render($content['field_flights_expiry_date']);
          ?>
      </div>
      <?php endif; ?>
