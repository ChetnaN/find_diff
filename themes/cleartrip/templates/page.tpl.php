...
//print '-'.theme_get_setting('logo_url');
  $pt_name = '';
  $ptid = 0;
  $vocabulary = 'category';
  $path = "";
...
if($ptid > 0) {
   $path = strtolower(str_replace(" ","-",taxonomy_term_load($ptid)->name));
}

$logo = '<img src="'.theme_get_setting('logo').'" border="0"/>';
$option = array('attributes' => array('class' => array('logo')), 'html' => TRUE);
...
<?php if (!preg_match('/(WebView)/i', strtolower($_SERVER['HTTP_USER_AGENT']))) { ?>
    ...
    <?php if ($site_logo || $site_name || $site_slogan): ?>
      ...
      <div<?php print $branding_attributes; ?>>
        ...
        <?php if ($site_logo): ?>
          <div id="logo">
            <?php //print $site_logo; ?>
            <?php print l(strtr($logo, array('http://' => '//', 'https://' => '//')) , $path , $option); ?>
          </div>
        <?php endif; ?>
 ...
 <?php  } ?>
  ...
  <!-- region: Secondary Content Lower -->
  <?php print render($page['secondary_content_lower']); ?>
  ...
  <div id="columns" class="columns clearfix">
    <div id="content-column" class="content-column" role="main">
      <div class="content-inner">
        ...
        <?php print render($page['highlighted_lower']); ?>
        <<?php print $tag; ?> id="main-content">
          ...
          <?php if (!preg_match('/(Mobile)/i', strtolower($_SERVER['HTTP_USER_AGENT']))) { 
          print $feed_icons;
          	} ?>
    ...
    // if (!preg_match('/(Mobile)/i', strtolower($_SERVER['HTTP_USER_AGENT']))) {
    	  $sidebar_second = render($page['sidebar_second']); print $sidebar_second; 
	  //}
   ?>
  ...
  <!-- region: Footer -->
  <?php if  ((!preg_match('/(Mobile)/i', strtolower($_SERVER['HTTP_USER_AGENT']))) && ($page['footer'])): ?>
